...
import { RefundEntity } from '../modules/payments/refund.entity';
import { WebhookEventEntity } from '../modules/payments/webhook-event.entity';
...
export function typeOrmConfig(config?: ConfigService): DataSourceOptions {
  ...
  const DATABASE_URL = explicitDatabaseUrl ?? getEnv('PAYMENTS_DATABASE_URL');
